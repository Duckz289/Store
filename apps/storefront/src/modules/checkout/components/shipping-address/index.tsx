    ...
    <>
      {customer && (addressesInRegion?.length || 0) > 0 && (
        <Container className="mb-6 flex flex-col gap-y-4 p-5">
          <p className="text-small-regular">
            {`Xin chào ${customer.first_name}, bạn có muốn dùng địa chỉ đã lưu không?`}
          </p>
          <AddressSelect
      ...
      <div className="grid grid-cols-1 small:grid-cols-2 gap-4">
        ...
        <Input
          ...
          onChange={handleChange}
          data-testid="shipping-address-note-input"
        />
        <Input
          label="Phường/Xã"
      ...
      <div className="my-8">
        <Checkbox
          label="Địa chỉ xuất hóa đơn giống địa chỉ giao hàng"
